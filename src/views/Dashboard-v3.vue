...
export default {
	...
	computed: {
    formattedStartDate() {
      return format(this.dateRange[0], 'dd MMMM yyyy');
    },
    formattedEndDate() {
      return format(this.dateRange[1], 'dd MMMM yyyy');
    },
  },
	methods: {
...
<template>
	...
	<div class="d-sm-flex align-items-center mb-3">
		<div class="btn btn-dark me-10px">
		...
		<div class="text-gray-600 fw-bold mt-2 mt-sm-0">compared to <span>24 Mar-30 Apr 2025</span></div>
	</div>
