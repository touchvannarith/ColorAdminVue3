...
<template>
	...
	<div id="header" class="app-header navbar navbar-expand-lg p-0">
		<div class="container-xxl px-3 px-lg-5 d-flex align-items-center flex-1">
			...
			<div class="ms-3">
				<RouterLink to="/" class="btn btn-theme fw-bold rounded-pill px-3 py-2 text-nowrap">Get started <i class="fa fa-arrow-right ms-2 opacity-5"></i></RouterLink>
			</div>
		</div>
	</div>
	<!-- END #header -->
	...
	<!-- BEGIN #home -->
	<div id="home" class="py-5 position-relative bg-black bg-size-cover" style="margin-top: 50px" data-bs-theme="dark">
		<!-- BEGIN container -->
		...
		<div class="position-absolute bg-size-cover bg-position-center bg-no-repeat top-0 start-0 w-100 h-100" style="background-image: url(/assets/img/coming-soon/coming-soon.jpg);"></div>
					...
					<div class="card border-0 rounded-4 h-100 bg-gray-900">
						<div class="card-body fs-14px p-30px d-flex flex-column">
							<div class="d-flex align-items-center">
								...
								<div>
									<Icon icon="solar:usb-bold-duotone" class="display-4 text-gray-400 rounded-3" />
								</div>
							</div>
							<hr class="my-4">
					...
					<div class="card border-0 rounded-4 h-100 bg-gray-900">
						<div class="card-body fs-14px p-30px d-flex flex-column">
							<div class="d-flex align-items-center">
								...
								<div>
									<Icon icon="solar:map-arrow-up-bold-duotone" class="display-4 text-gray-400 rounded-3" />
								</div>
							</div>
							<hr class="my-4">
							<div class="mb-5 text-body flex-1">
					...
					<div class="card border-0 rounded-4 shadow-lg bg-gradient-cyan-blue text-white h-100">
						<div class="card-body fs-15px p-30px h-100 d-flex flex-column">
							<div class="d-flex align-items-center">
								...
								<div>
									<Icon icon="solar:cup-first-bold-duotone" class="display-3 text-black text-opacity-50 rounded-3" />
								</div>
							</div>
					...
					<div class="card border-0 rounded-4 h-100 bg-gray-900">
						<div class="card-body fs-14px p-30px d-flex flex-column">
							<div class="d-flex align-items-center">
								...
								<div>
									<Icon icon="solar:buildings-bold-duotone" class="display-4 text-gray-400 rounded-3" />
								</div>
							</div>
							<hr class="my-4">
							<div class="mb-5 text-white text-opacity-75 flex-1">
