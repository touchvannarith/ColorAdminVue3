...
export default {
	data() {
		...
		appOption.appContentClass = 'p-0 bg-component';
		...
		<div class="d-lg-flex mb-lg-3 mb-2">
			...
			<span class="d-none d-lg-flex align-items-center">
				<a href="#" class="btn btn-secondary btn-sm d-flex me-2 pe-3 rounded-3">
					<Icon class="iconify fs-18px me-2 ms-n1" icon="solar:printer-bold-duotone" />
					Print Result
				</a>
				<a href="#" class="btn btn-secondary btn-sm d-flex me-2 pe-3 rounded-3">
					<Icon class="iconify fs-18px me-2 ms-n1" icon="solar:archive-down-minimlistic-bold-duotone" />
					Export Excel
				</a>
				<a href="#" class="btn btn-theme btn-sm d-flex pe-3 rounded-3">
					<Icon class="iconify fs-18px me-2 ms-n1" icon="solar:refresh-bold-duotone" />
					Reload Data
				</a>
			</span>
		</div>
		<div class="row gx-2 pb-10px">
			...
			<div class="col-lg-2 d-lg-block d-none">
				<a href="#" class="btn btn-white d-flex align-items-center rounded-3" data-bs-toggle="dropdown">
					...
					<Icon class="iconify fs-20px my-n1 me-2 ms-n1 text-theme" icon="solar:calendar-search-linear" />
					Date Range
					<i class="fa ms-auto fa-chevron-down"></i>
				</a>
				<ul class="dropdown-menu">
					<li><a class="dropdown-item d-flex align-items-center" href="#"><Icon class="iconify fs-20px my-n1 me-2 ms-n1 text-body text-opacity-50" icon="solar:calendar-line-duotone" /> Last 7 Days</a></li>
					<li><a class="dropdown-item d-flex align-items-center" href="#"><Icon class="iconify fs-20px my-n1 me-2 ms-n1 text-body text-opacity-50" icon="solar:calendar-line-duotone" /> Last 30 Days</a></li>
					<li><a class="dropdown-item d-flex align-items-center" href="#"><Icon class="iconify fs-20px my-n1 me-2 ms-n1 text-body text-opacity-50" icon="solar:calendar-line-duotone" /> This Month</a></li>
					<li><a class="dropdown-item d-flex align-items-center" href="#"><Icon class="iconify fs-20px my-n1 me-2 ms-n1 text-body text-opacity-50" icon="solar:calendar-line-duotone" /> Last Month</a></li>
					<li><a class="dropdown-item d-flex align-items-center" href="#"><Icon class="iconify fs-20px my-n1 me-2 ms-n1 text-body text-opacity-50" icon="solar:calendar-line-duotone" /> Custom Range</a></li>
				</ul>
			</div>
			<div class="col-lg-2 d-lg-block d-none">
				<a href="#" class="btn btn-white d-flex align-items-center rounded-3" data-bs-toggle="dropdown">
					<i class="fa fa-lg fa-tags me-10px text-body text-opacity-50 d-none"></i>
					<Icon class="iconify fs-20px my-n1 me-2 ms-n1 text-theme" icon="solar:tag-linear" />
					Status
					<i class="fa ms-auto fa-chevron-down"></i>
				</a>
				<ul class="dropdown-menu">
			...
			<div class="col-lg-2 d-lg-block d-none">
				<a href="#" class="btn btn-white d-flex align-items-center rounded-3" data-bs-toggle="dropdown">
					...
					<Icon class="iconify fs-20px my-n1 me-2 ms-n1 text-theme" icon="solar:map-point-linear" />
					Location
					<i class="fa ms-auto fa-chevron-down"></i>
				</a>
				<ul class="dropdown-menu">
					<li><a class="dropdown-item d-flex align-items-center" href="#"><Icon class="iconify fs-20px my-n1 me-2 ms-n1 text-body text-opacity-50" icon="solar:map-point-linear" /> New York City, New York, USA</a></li>
					<li><a class="dropdown-item d-flex align-items-center" href="#"><Icon class="iconify fs-20px my-n1 me-2 ms-n1 text-body text-opacity-50" icon="solar:map-point-linear" /> London, United Kingdom</a></li>
					<li><a class="dropdown-item d-flex align-items-center" href="#"><Icon class="iconify fs-20px my-n1 me-2 ms-n1 text-body text-opacity-50" icon="solar:map-point-linear" /> Tokyo, Japan</a></li>
					<li><a class="dropdown-item d-flex align-items-center" href="#"><Icon class="iconify fs-20px my-n1 me-2 ms-n1 text-body text-opacity-50" icon="solar:map-point-linear" /> Sydney, Australia</a></li>
					<li><a class="dropdown-item d-flex align-items-center" href="#"><Icon class="iconify fs-20px my-n1 me-2 ms-n1 text-body text-opacity-50" icon="solar:map-point-linear" /> Paris, France</a></li>
				</ul>
			</div>
			<div class="col-lg-2 d-lg-block d-none">
				<a href="#" class="btn btn-white d-flex align-items-center rounded-3" data-bs-toggle="dropdown">
					<Icon class="iconify fs-20px my-n1 me-2 ms-n1 text-theme" icon="solar:tuning-linear" />
					More filters
					<i class="fa ms-auto fa-chevron-down"></i>
				</a>
				<ul class="dropdown-menu">
