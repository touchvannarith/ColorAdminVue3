	...
	<div style="min-height: 100vh; background: url(/assets/img/cover/cover-scrum-board.png) no-repeat fixed; background-size: 360px; background-position: right bottom;">
		...
		<div class="mb-3 d-md-flex fw-bold">
			<div class="dropdown-toggle">
				<a href="#" data-bs-toggle="dropdown" class="text-decoration-none text-dark"><i class="far fa-folder fa-fw text-dark text-opacity-50 me-1"></i> project/color-admin <b class="caret"></b></a>
		...
		<div class="row">
			<div class="col-xl-4 col-lg-6">
				<panel>
					<panel-header>
						<panel-title>To do (5)</panel-title>
						<panel-toolbar />
					</panel-header>
			...
			<div class="col-xl-4 col-lg-6">
				<panel>
					<panel-header>
						<panel-title>In Progress (2)</panel-title>
						<panel-toolbar />
					</panel-header>
					<div class="list-group list-group-flush rounded-bottom overflow-hidden panel-body p-0">
						<div class="list-group-item d-flex border-top-0">
			...
			<div class="col-xl-4 col-lg-6">
				<panel>
					<panel-header>
						<panel-title>Done (1)</panel-title>
						<panel-toolbar />
					</panel-header>
					<div class="list-group list-group-flush rounded-bottom overflow-hidden panel-body p-0">
						<div class="list-group-item  d-flex border-top-0">
